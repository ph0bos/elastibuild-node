...
class QueryBuilder {
  ...
  withMoreLikeThis(fields, id, options) {
    this.q.query.more_like_this = {};
    this.q.query.more_like_this.fields = fields;
    this.q.query.more_like_this.min_term_freq = options.min_term_freq || DEFAULT_MIN_TERM_FREQ;
    this.q.query.more_like_this.max_query_terms = options.max_query_terms || DEFAULT_MAX_TERM_FREQ;
    this.q.query.more_like_this.minimum_should_match = options.minimum_should_match || DEFAULT_MIN_SHOULD_MATCH;
    this.q.query.more_like_this.min_doc_freq = options.min_doc_freq || DEFAULT_MIN_DOC_FREQ;
    this.q.query.more_like_this.docs = [ { _index: options._index, _type: options._type, _id: id } ];
  }
