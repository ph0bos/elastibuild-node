...
QueryBuilder.prototype.withMustMatch = function(field, values) {
  this._buildBoolMust();
  ...
  if (util.isArray(values)) {
    values.forEach(function(v) {
      self.query.query.filtered.query.bool.must.push(self._buildSubQuery(field, v));
    });
  } else {
    self.query.query.filtered.query.bool.must.push(self._buildSubQuery(field, values));
  }
};
